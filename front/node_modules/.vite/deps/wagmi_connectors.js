import {
  RpcSchema_exports,
  mini_exports
} from "./chunk-3VPAWRW2.js";
import "./chunk-IJNVDTF4.js";
import "./chunk-ANJCMEYS.js";
import "./chunk-3H6QX4HC.js";
import {
...
import {
  withRetry,
  withTimeout
} from "./chunk-XHXVRDUU.js";
import "./chunk-TYZ2TZAJ.js";
import "./chunk-7PQ5ULVT.js";
import {
  ...
  hexToNumber,
  numberToHex
} from "./chunk-NG255MLZ.js";
import "./chunk-FS6F6PZX.js";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-7RKSY4VK.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-DMF23SCX.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-563Q7U4Q.js");
  ...
  return createConnector((wagmiConfig) => {
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ??= (async () => {
          const { Porto } = await import("./_dist-Y2TPE6RW.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-GIRH6RTJ.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-T4KU2LU6.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-QOFGHG3H.js");
